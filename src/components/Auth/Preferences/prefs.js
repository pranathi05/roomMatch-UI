export const prefs = [
  ...
  {
    question: `What's your budget for rent?`,
    type: 'range',
    name: 'rent',
    label: 'Rent',
  },
  ...
  {
    question: `How early can you move in? (days)`,
    type: 'number',
    name: 'joining',
    label: 'Joining Time',
  },
  {
    question: `What's your ideal location?`,
    type: 'text',
    name: 'idealLocation',
  ...
  {
    question: `When do you go to sleep at night?`,
    type: 'select',
    name: 'sleepTime',
    label: 'Sleep Time',
  },
